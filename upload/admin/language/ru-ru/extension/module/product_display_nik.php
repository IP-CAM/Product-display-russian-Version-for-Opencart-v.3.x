<?php
// Heading
$_['heading_title']    = 'Pекомендуемые / Просмотренные / Избранные - товары';
...
$_['entry_display_ordered'] = 'Показывать товары из Заказаных';
$_['entry_display_viewed'] = 'Показывать товары из Просмотренных';
$_['entry_display_favorite'] = 'Показывать товары из Избранных';
$_['entry_display_bestsellers'] = 'Показывать товары из Бестселлеры продаж';
$_['entry_display_recommendation'] = 'Показывать товары из Рекомендуемых';
$_['entry_count_products'] = 'Количество товаров';
